...
export const projectsData: Project[] = [
    ...
    },
    {
        ...
        images: [
            `${base}/Restaurant/img1.png`,
            `${base}/Restaurant/img2.png`,
            `${base}/Restaurant/img3.png`,
            `${base}/Restaurant/img4.png`,
            `${base}/Restaurant/img5.png`,
            `${base}/Restaurant/img6.png`,
            `${base}/Restaurant/img7.png`,
            `${base}/Restaurant/img8.png`,
            `${base}/Restaurant/img9.png`,
        ],
